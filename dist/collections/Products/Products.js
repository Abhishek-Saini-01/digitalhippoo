...
exports.Products = {
    ...
    hooks: {
        ...
        beforeChange: [addUser, function (args) { return __awaiter(void 0, void 0, void 0, function () {
                var data, createdPorduct, updated, data, updatedPorduct, updated;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            createdPorduct = _a.sent();
                            updated = __assign(__assign({}, data), { stripeId: createdPorduct.id, priceId: createdPorduct.default_price });
                        ...
                        case 3:
                            updatedPorduct = _a.sent();
                            updated = __assign(__assign({}, data), { stripeId: updatedPorduct.id, priceId: updatedPorduct.default_price });
                            return [2 /*return*/, updated];
