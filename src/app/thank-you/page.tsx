          ...
          <div className="lg:col-start-2">
            ...
            {order._isPaid ? (
              <p className="mt-2 text-base text-muted-foreground">
                Your order was processed and your assets are available to download below. we&apos;ve sent your receipt and order details
                to {typeof order.user !== 'string' ? (
            ...
            <div className="mt-16 text-sm font-medium">
                      ...
                      <div className="relative h-24 w-24">
                        {
                          typeof image !== 'string' && image.url ? (
                            <Image 
                              ...
                              className="flex-nowrap rounded-md bg-gray-100 object-cover object-center"
                              fill
              ...
              <div className="mt-16 border-t border-gray-200 py-6 text-right">
                <Link href='/products' className="text-sm font-medium text-blue-600 hover:text-blue-500" >Continue Shopping &rarr;</Link>
              </div>
            </div>
          </div>
        </div>
